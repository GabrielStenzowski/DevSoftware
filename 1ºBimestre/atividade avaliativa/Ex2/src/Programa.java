...
public class Programa {
	...
	public static void main(String[] args) {
		...
		System.out.println("Deu boa demais!!");
	}
	...
	public static void gravarRelatorio(Grupo[] grupos) {
		try {
			...
			Formatter gravador = new Formatter(
					"C:\\Users\\Aluno\\Desktop\\atividade avaliativa\\Ex2\\src\\relatorio-de-grupos.txt");
	...
	public static Scanner getLeitor() {
		File arquivo = new File("C:\\Users\\Aluno\\Desktop\\atividade avaliativa\\Ex2\\src\\grupos-tabulados.txt");
		...
		try {
			...
			System.out.println("Arquivo não achado, procure novamente!!!");
		}
		return leitor;
	}	
